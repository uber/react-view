  ...
  return (
    <Layout>
      ...
      <P>
        ...
        have too many options). Those are much nicer and faster to use than
        inputs.
      </P>
      <P>
        But what if you want to add something custom that we do not support yet?
        There is a <Inline>customProp</Inline> API that you can use. You can
        control both the knob and also the internal representation of the value.
        In this example, we add a pretty simple custom knob. We want to
        represent the <Inline>value</Inline> with an input slider.
      </P>
      <Compiler
      ...
      <Slider
        value={params.knobProps.state.value.value as number}

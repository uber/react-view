...
const TypescriptCodeOnly = () => {
  ...
  return (
    <Layout>
      ...
      <P>
        We use babel to compile the code that user passes to the editor. By
        default, we apply only{' '}
        <a href="https://babeljs.io/docs/en/babel-preset-react">
          @babel/preset-react
        </a>{' '}
        but you can import and use additional babel plugins. Do you want to
        support <a href="https://flow.org/">Flow</a>? Add{' '}
        <a href="@babel/preset-flow">@babel/preset-flow</a> instead.
      </P>
      <P>
        In this case, we have added{' '}
        <a href="https://babeljs.io/docs/en/babel-preset-typescript">
          @babel/preset-typescript
        </a>{' '}
        to support TypeScript. This preset strips out all the TypeScript code
        but it does not validate types.
      </P>
      <CompilerBox>
      ...
      <H2>Usage</H2>
      <P>
        The compiler component accepts an optional array of presets. You should
        also set the editor language to TSX to get a proper syntax highlighting.
      </P>
      <Code>
...
export default () => {
  ...
  return (
    <React.Fragment>
      ...
      <P>
        <b>Note:</b> If you use react-view in the full mode (with the
